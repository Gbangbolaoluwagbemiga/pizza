        ...
        <div>
          ...
          <div>
            <input
              type="text"
              name="address"
              className="w-full rounded-full border border-stone-200 px-4 py-2 text-sm
        ...
        <div>
          ...
          <button
            ...
            className="inline-block rounded-full bg-yellow-400 px-2 py-2 font-semibold
             uppercase tracking-wide text-stone-800 transition-all duration-300 hover:bg-yellow-300
